...
const TalentsPage = lazy(() => import('@/components/pages/TalentsPage').catch(err => {
  console.error('Failed to load TalentsPage:', err);
  throw err;
}));
const FactionPage = lazy(() => import('@/components/pages/FactionPage').catch(err => {
  console.error('Failed to load FactionPage:', err);
  throw err;
}));
const RankingPage = lazy(() => import('@/components/pages/RankingPage').catch(err => {
  console.error('Failed to load RankingPage:', err);
  throw err;
}));
...
const FeatureGateRoute = lazy(() => import('@/components/routes/FeatureGateRoute').catch(err => {
  console.error('Failed to load FeatureGateRoute:', err);
  throw err;
}));
const ProtectedRoute = lazy(() => import('@/components/routes/ProtectedRoute').catch(err => {
