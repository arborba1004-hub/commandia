 ...
 *
 *   ESTATÍSTICAS → Multiplicadores de conta que amplificam os atributos base.
 *                  Começam em 1.0 (sem bônus = 100% do base).
 *                  São alimentadas por formação, CT, arsenal, suborno, etc.
 *                  Análogo: "All Crew Attack +150%", "Capanga Defense +80%" no Mafia City.
 *
 *   STAT EFETIVA = atributo_base × multiplicador_global × multiplicador_por_tipo
 *
 * ─── ESTRUTURA DOS BÔNUS ──────────────────────────────────────────────────────
 *
